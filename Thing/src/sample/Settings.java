...
public class Settings {
    ...
    public static final double HARVESTER_ENERGY_USE = 4;
   ...
   //----------------------------------------------------------
    ...
    ////----------------- No obstacle ---------------
/*    public static final Map MAP = MapGenerator.genObstacleFreeMap("Dynamic", 30, 30, new OpenCell(16,18, 20), new OpenCell(14,12, 20)
            ,new OpenCell(29, 29, 20));*/
